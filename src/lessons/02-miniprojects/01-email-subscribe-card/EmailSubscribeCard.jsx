    ...
    <div className="flex h-screen items-center justify-center bg-zinc-700">
      ...
      <div className="mx-6 rounded-2xl bg-zinc-800 p-2">
        ...
        <div className="flex flex-col rounded-l-xl md:flex-row">
          {/* Image */}
          <img
            src="../../../assets/img/mini-email/image.jpg"
            alt=""
            className="object-fit h-80 transform rounded-xl duration-200 hover:scale-105 hover:rounded-xl md:h-64 md:rounded-l-xl md:rounded-r-none"
          />
          ...
          <div className="p-6 md:p-12">
            ...
            <div className="mt-5 flex flex-col space-y-4 md:flex-row md:space-x-3 md:space-y-0">
              <input
                ...
                className="border border-zinc-600 bg-zinc-800 p-2 px-4 text-center text-white placeholder:text-center focus:text-left focus:outline-none md:text-left placeholder:md:text-left"
              />

              <button className="rounded-md bg-lime-500 px-5 py-3 text-zinc-800 duration-500 hover:bg-lime-700 hover:text-white">
                Subscribe
              </button>
            </div>
          </div>
