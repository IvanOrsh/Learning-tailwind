  ...
  return (
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-100">
      ...
      <div className="m-3 flex flex-col space-y-10 rounded-2xl bg-white p-6 shadow-2xl md:m-0 md:flex-row md:space-y-0 md:space-x-10 md:p-16">
        ...
        <div>
          <img
            src="../../../assets/img/product-modal/headphone.png"
            alt="headphones"
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="mb-4 flex flex-col space-y-3 text-center md:text-left">
            ...
            {/* Price Container */}
            <div className="md:test-left mb-4 flex flex-col space-y-3 text-center md:text-left">
              <p className="line-through">$799</p>
              <p className="text-5xl font-bold">$599</p>
              <p className="text-sm font-light text-gray-400">
                This offer is valid until Apriil 3rd or as long as stock lasts!
              </p>
            </div>
            ...
            <div className="flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4">
              <button className="flex items-center justify-center space-x-3 rounded-lg border-2 border-gray-300 py-3 px-5 shadow-sm transition-all duration-150 hover:-translate-y-0.5 hover:bg-opacity-30 hover:shadow-lg">
                <img
                  src="../../../assets/img/product-modal/weight.png"
                  alt=""
                  className="w-8"
                />
              ...
              <button className="flex items-center justify-center space-x-3 rounded-lg border-2 border-gray-300 py-3 px-5 shadow-sm transition-all duration-150 hover:-translate-y-0.5 hover:bg-opacity-30 hover:shadow-lg">
                <img
                  src="../../../assets/img/product-modal/heart.png"
                  alt=""
                  className="w-8"
                />
